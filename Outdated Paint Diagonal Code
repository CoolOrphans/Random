	...
	public static void main(String[] args) {
		...
		for (int ix = 0; ix < width; ix += k) {
			for (int iy = 0; iy < height; iy += k) {
				...
				gmh = random(0, 255);
				bmh = random(0, 255);
				c.diagonalPaint2(random(0, 255), random(0, 255), random(0, 255), g, ix, iy, ix + k, iy + k,
						randomBool(), randomBool(), randomBool(), rmh, random(0, rmh), gmh, random(0, gmh), bmh,
						random(0, bmh), random(1, 50), random(1, 50), random(1, 50), random(1, 50), random(1, 50),
						random(1, 50));
			}
		}
